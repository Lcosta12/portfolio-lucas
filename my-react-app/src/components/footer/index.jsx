...
export const Footer = () => {
  return (
    <ContactSection>
      ...
      <ContactDiv>
        <WhatsAppButton
          phoneNumber="5551996618608"
          message="Olá, estou entrando em contato através do seu site."
        />
        <EmailLink
          email="lucascosta120903@gmail.com"
          subject="Contato via site"
          body="Boa tarde gostaria de entrar em contato"
        >
